...
10. Для получения географического центра федерального округа (<b>ФО</b>) в строке ендпоинта нашего API вводим адрес: <b>http://localhost:8080/getGeoCenterForDistrict</b>
11. Формат ввода данных аналогичен работе с областями, за исключением названия ФО. <b>ФО</b> вводится в виде аббревиатуры. Например, Приволжский федеральный округ - <b>"пфо"</b>, Северо-Западный федеральный округ - <b>"сзфо"</b>.
12. В случае некорректного ввода данных также получим сообщение об ошибке.
